...
const (
	...
	BudgetService_GetBudgets_FullMethodName    = "/budget.BudgetService/GetBudgets"
	BudgetService_GetBudgetById_FullMethodName = "/budget.BudgetService/GetBudgetById"
...
type BudgetServiceClient interface {
	...
	GetBudgets(ctx context.Context, in *GetBudgetsRequest, opts ...grpc.CallOption) (*BudgetsResponse, error)
	GetBudgetById(ctx context.Context, in *GetBudgetByIdRequest, opts ...grpc.CallOption) (*BudgetResponse, error)
	UpdateBudget(ctx context.Context, in *UpdateBudgetRequest, opts ...grpc.CallOption) (*BudgetResponse, error)
	DeleteBudget(ctx context.Context, in *DeleteBudgetRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *budgetServiceClient) GetBudgets(ctx context.Context, in *GetBudgetsRequest, opts ...grpc.CallOption) (*BudgetsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BudgetsResponse)
...
func (c *budgetServiceClient) GetBudgetById(ctx context.Context, in *GetBudgetByIdRequest, opts ...grpc.CallOption) (*BudgetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BudgetResponse)
	err := c.cc.Invoke(ctx, BudgetService_GetBudgetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *budgetServiceClient) DeleteBudget(ctx context.Context, in *DeleteBudgetRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type BudgetServiceServer interface {
	...
	GetBudgets(context.Context, *GetBudgetsRequest) (*BudgetsResponse, error)
	GetBudgetById(context.Context, *GetBudgetByIdRequest) (*BudgetResponse, error)
	UpdateBudget(context.Context, *UpdateBudgetRequest) (*BudgetResponse, error)
	DeleteBudget(context.Context, *DeleteBudgetRequest) (*Empty, error)
...
func (UnimplementedBudgetServiceServer) GetBudgets(context.Context, *GetBudgetsRequest) (*BudgetsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBudgets not implemented")
}
func (UnimplementedBudgetServiceServer) GetBudgetById(context.Context, *GetBudgetByIdRequest) (*BudgetResponse, error) {
...
func (UnimplementedBudgetServiceServer) DeleteBudget(context.Context, *DeleteBudgetRequest) (*Empty, error) {
...
func _BudgetService_GetBudgetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetService_GetBudgetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BudgetService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "budget-service/budget-service.proto",
}
